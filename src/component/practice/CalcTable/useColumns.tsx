        ...
        children: [
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                value={text}
                type="number"
                updateToData={useCallback(updateToData(index, "index"), [
                  index,
                ])}
                controls={false}
                min={1}
          ...
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                value={text}
                type="text"
                updateToData={useCallback(updateToData(index, "tenantNo"), [
                  index,
                ])}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                updateToData={useCallback(updateToData(index, "phaseNo"), [
                  index,
                ])}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                updateToData={useCallback(updateToData(index, "buildingNo"), [
                  index,
                ])}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                updateToData={useCallback(updateToData(index, "floorNo"), [
                  index,
                ])}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                updateToData={useCallback(updateToData(index, "status"), [
                  index,
                ])}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                type="text"
                value={text}
                updateToData={useCallback(updateToData(index, "alternatives"), [
                  index,
                ])}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                updateToData={useCallback(updateToData(index, "propertyType"), [
                  index,
                ])}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                updateToData={useCallback(
                  updateToData(index, "propertySubtype"),
                  [index]
                )}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                updateToData={useCallback(
                  updateToData(index, "tenantAttribute"),
                  [index]
                )}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                updateToData={useCallback(updateToData(index, "tenantType"), [
                  index,
                ])}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                updateToData={useCallback(updateToData(index, "isTax"), [
                  index,
                ])}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                updateToData={useCallback(
                  updateToData(index, "rentAlternative"),
                  [index]
                )}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                value={text}
                updateToData={useCallback(
                  updateToData(index, "constructionArea"),
                  [index]
                )}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                type="number"
                value={text}
                updateToData={useCallback(updateToData(index, "rentArea"), [
                  index,
                ])}
              />
            ),
        ...
        children: [
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                value={text}
                updateToData={useCallback(
                  updateToData(index, "rentStartDate"),
                  [index]
                )}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                type="date"
                value={text}
                updateToData={useCallback(updateToData(index, "rentEndDate"), [
                  index,
                ])}
              />
            ),
          ...
          // },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                value={text}
                updateToData={useCallback(
                  updateToData(index, "rentFreeStartDate"),
                  [index]
                )}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                value={text}
                updateToData={useCallback(
                  updateToData(index, "rentFreeEndDate"),
                  [index]
                )}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                updateToData={useCallback(updateToData(index, "rentUnit"), [
                  index,
                ])}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                value={text}
                updateToData={useCallback(
                  updateToData(index, "rentUnitPrice"),
                  [index]
                )}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                type="number"
                value={text}
                updateToData={useCallback(updateToData(index, "annualRent"), [
                  index,
                ])}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                type="number"
                value={text}
                updateToData={useCallback(updateToData(index, "actualRent"), [
                  index,
                ])}
              />
            ),
          ...
          // },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                type="number"
                value={text}
                updateToData={useCallback(updateToData(index, "termValue"), [
                  index,
                ])}
              />
            ),
        ...
        children: [
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                type="number"
                value={text}
                updateToData={useCallback(updateToData(index, "marketRent"), [
                  index,
                ])}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                type="number"
                value={text}
                updateToData={useCallback(updateToData(index, "vacancyRate"), [
                  index,
                ])}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                value={text}
                updateToData={useCallback(
                  updateToData(index, "annualRentOutOfLease"),
                  [index]
                )}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                value={text}
                updateToData={useCallback(
                  updateToData(index, "remainingYearPeriod"),
                  [index]
                )}
              />
            ),
...

          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                value={text}
                updateToData={useCallback(
                  updateToData(index, "reversionaryValue"),
                  [index]
                )}
              />
            ),
        ...
        children: [
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                value={text}
                updateToData={useCallback(
                  updateToData(index, "marketValuation"),
                  [index]
                )}
              />
            ),
          },
          {
            ...
            render: (text, record, index) => (
              <AutoCell
                ...
                value={text}
                updateToData={useCallback(
                  updateToData(index, "marketUnitPrice"),
                  [index]
                )}
              />
            ),
